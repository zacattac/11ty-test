...
const customFootnotes = require("../plugins/remark/footnotes");
const references = require("../plugins/remark/references");
const imagesWithCaptions = require("../plugins/remark/imagesWithCaptions");
